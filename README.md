...
`OUT` and `LEFT QUEUE` update the live state immediately and offer a short undo. The database remains authoritative and rejects any admission or undo that would exceed the 15-person limit.
